...
document.getElementById('reference-title').textContent = referenceData.title;
document.getElementById('reference-source').textContent = referenceData.source;
document.getElementById('reference-description').textContent = referenceData.description;
document.getElementById('reference-input-format').textContent = referenceData.input_format;
document.getElementById('reference-output-format').textContent = referenceData.output_format;
document.title = referenceData.title;

const testCasesContainer = document.getElementById('test-cases');
testCasesContainer.innerHTML = '';

referenceData.sample_testcases.forEach((testCase, index) => {
    const testCaseDiv = document.createElement('div');
    testCaseDiv.innerHTML = `
        <div class="referenceintitle" style="font-size: 14px;">테스트케이스 ${index + 1}:<br></div>
...
document.getElementById('reference-additional-info').textContent = `메모리 제한: ${referenceData.memory_limit}, 시간 제한: ${referenceData.time_limit}`;

document.getElementById('reference-difficulty').textContent = `난이도 : ${referenceData.difficulty}`;
document.getElementById('reference-source-detail').textContent = `출처: ${referenceData.source}`;
